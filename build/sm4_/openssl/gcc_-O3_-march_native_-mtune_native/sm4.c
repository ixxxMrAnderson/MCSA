...
void sm4_encrypt(const uint8_t *in, uint8_t *out, const uint32_t *ks)
{
...
void ossl_sm4_decrypt(const uint8_t *in, uint8_t *out, const uint32_t *ks)
{
    uint32_t B0 = load_u32_be(in, 0);
    uint32_t B1 = load_u32_be(in, 1);
    uint32_t B2 = load_u32_be(in, 2);
